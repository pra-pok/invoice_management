    ...
    <div id="invoice" class="effect21">
      ...
      <div id="invoice-top">
        ...
        <div class="title">
          ...
          <p>{{__('invoice.issue_date')}}: <span id="invoice_date">{{ date('d m Y'), strtotime($invoice->invoice_date) }}</span><br>
          <p>{{__('invoice.due_date')}}: <span id="invoice_date">{{ date('d m Y'), strtotime($invoice->invoice_due_date) }}</span><br>
          </p>
        </div><!--End Title-->
      </div><!--End InvoiceTop-->
      ...
      <div id="invoice-mid">
        <div id="message">
          <h2 style="margin-left: 20px">{{__('backend.hello')}} {{ $invoice->customer->name }},</h2>
