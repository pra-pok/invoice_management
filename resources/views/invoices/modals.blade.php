                ...
                <div class="modal-header">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            @else
                            <h3>{{__('invoice.new_invoice')}}</h3>
                            @endif
                        </div>
                      
                        @if (!isset($invoice))
                        <div class="col-md-2">
                            <a href="#" class="float-right1 select-existing-customer btn btn-warning btn-sm">{{__('invoice.select_customer')}}</a>
                        </div>
                        @endif
                        <div class="col-xs-2 float-right">
                            <div class="input-group ">
                                ...
                                <input type="text" name="invoice_id" readonly id="invoice_id" class="form-control required" placeholder="Invoice Number" aria-describedby="sizing-addon1" value="{{  isset($invoice) ? $invoice->id  : $setting->invoice_initial_value }}"> 
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">{{__('invoice.select_customer')}}</h4>
                </div>
                <div class="modal-body">
                    <div id="ContainerTable">
