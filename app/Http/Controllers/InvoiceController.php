    ...
    public function show(Request $request, Invoice $invoice)
{
    ...
    // Set the application's locale (this will work for translations in HTML)
    app()->setLocale($locale);

    // Prepare data for the PDF
    $data = [
        'invoice' => $invoice->load(['customer', 'invoiceDetails', 'invoiceDetails.product']),
    ...
    $pdf->setOption('font', public_path('fonts/NotoSansCJK-Regular.ttf'));

    // Handle the requested option
